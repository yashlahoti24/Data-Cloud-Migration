    ...
    if os.path.isfile("./media/database/database_1.pickle"):
        with open("./media/database/database_1.pickle", "rb") as pickleObj:
            try:
                ...
                return render_template('public-key-list.html', msg='Error loading data from pickle file: {}'.format(str(e)))
    else:
        return render_template('public-key-list.html', msg='No public key found in the database')
